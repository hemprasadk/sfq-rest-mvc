...
import static prasad.springframework.restapimvc.controllers.v1.AbstractRestControllerTest.asJsonString;
...
public class CustomerControllerTest {
    ...
    public void getAllCustomer()  throws Exception {
        ...
        when(customerService.getcustomer()).thenReturn(Arrays.asList(customer1, customer2));
